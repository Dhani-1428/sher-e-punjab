    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {showAllProductsVideoHero ? (
          ...
          >
            <video
              className="block h-full w-full max-h-[min(70vh,520px)] min-h-[200px] object-cover object-center"
              autoPlay
              muted
              loop
              playsInline
            ...
            {/* Centered card masks Envato watermark (typically mid-frame on preview footage) */}
            <div className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center px-4 py-6 sm:px-8">
              <div className="w-full max-w-lg rounded-2xl border border-white/35 bg-background px-5 py-4 text-foreground shadow-2xl backdrop-blur-md md:max-w-xl md:px-8 md:py-6">
